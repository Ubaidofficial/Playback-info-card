...
(function (global) {
    ...
    var BRAND_SVG = {
        ...
        appletv: '<svg viewBox="0 0 24 24" width="20" height="20"><rect x="2" y="5" width="20" height="12" rx="2" fill="#1d1d1f" stroke="#6b7280" stroke-width="1"/><circle cx="12" cy="11" r="3.2" fill="#fff"/></svg>',
        ...
        linux: '<svg viewBox="0 0 24 24" width="20" height="20"><ellipse cx="12" cy="14" rx="6" ry="7" fill="#1a1a1a" stroke="#6b7280" stroke-width="0.75"/><ellipse cx="12" cy="15.2" rx="3.6" ry="4.6" fill="#fff"/><circle cx="10" cy="8.5" r="1" fill="#1a1a1a"/><circle cx="14" cy="8.5" r="1" fill="#1a1a1a"/><ellipse cx="12" cy="7.2" rx="4" ry="4.4" fill="#1a1a1a" stroke="#6b7280" stroke-width="0.75"/><path d="M9 20l-1.5 2M15 20l1.5 2" stroke="#F7C948" stroke-width="1.6" stroke-linecap="round" fill="none"/></svg>',
