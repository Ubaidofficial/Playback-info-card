...
public class PlaybackCardDashboardMiddleware
{
    ...
    private const string DashboardScriptTag =
        "<link plugin=\"PlaybackCard\" rel=\"stylesheet\" href=\"/PlaybackCard/dashboard.css?v=0.2.5.1\" data-asset-revision=\"0.2.5.1\">\n" +
        "<script plugin=\"PlaybackCard\" version=\"0.2.5.1\" data-asset-revision=\"0.2.5.1\" src=\"/PlaybackCard/dashboard.js?v=0.2.5.1\" defer></script>\n";
