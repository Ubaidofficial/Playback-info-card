...
public class PlaybackCardDashboardMiddlewareTests
{
    ...
    public async Task InvokeAsync_DirectScriptRoute_ServesDashboardJsWithCorrectContentType()
    {
        ...
        Assert.Contains("0.2.6.0", content);
    ...
    public async Task InvokeAsync_IndexHtml_InjectsScriptAndLinkBeforeBodyClosingTag()
    {
        ...
        Assert.Contains("<script plugin=\"PlaybackCard\" version=\"0.2.6.0\" data-asset-revision=\"0.2.6.0\" src=\"/PlaybackCard/dashboard.js?v=0.2.6.0\" defer></script>", modifiedHtml);
        Assert.Contains("<link plugin=\"PlaybackCard\" rel=\"stylesheet\" href=\"/PlaybackCard/dashboard.css?v=0.2.6.0\" data-asset-revision=\"0.2.6.0\">", modifiedHtml);
    ...
    public async Task InvokeAsync_GzipCompressedHtml_DecompressesInjectsAndRecompresses()
    {
        ...
        Assert.Contains("version=\"0.2.6.0\"", decompressedHtml);
    }
